...
:p.šber das simple Abspielen einer CD hinaus ist der CD Spieler in der Lage,
...
:link reftype=hd res=15000.Einstellungen:elink. beeinfluát werden.
...
CD Spieler máte auch mit OS/2 2.0 und Multimediaerweiterung arbeiten, dieser
...
Das Projekt wurde aber immer gr”áer und wuchs bald weit ber diese
...
:i2 REFID=INDEX_TITLEEDITOR.šberblick
...
kann bis zu 100 Zeichen lang sein. Bedenken Sie jedoch, daá sehr lange
...
:i2 REFID=INDEX_PROGRAMEDITOR.šberblick
...
fr das Programm sind, daá es mindestens einen, h”chstens aber 256
Titel enth„lt, und daá das Programms nicht l„nger als 100 Stunden ist.
...
kann man sich einen šberblick ber die vorhandenen
...
:note.
Die Darstellung der Gesamtl„nge l„át sich in den
:link reftype=hd res=15000.Einstellungen:elink. unter
...
":link reftype=hd res=13243.Titel entfernen:elink.". Auáerdem bestimmt
...
:note.
Es werden nur soviel Titel eingefgt, daá das Programm nicht mehr als 256
...
:i2 REFID=INDEX_INFOWINDOW.šberblick
...
:note.
Die Darstellung der Startposition l„át sich in den
:link reftype=hd res=15000.Einstellungen:elink. unter
:link reftype=hd res=15100.Zeitformat:elink. ver„ndern.
...
:note.
Die Darstellung der L„nge l„át sich in den
:link reftype=hd res=15000.Einstellungen:elink. unter
:link reftype=hd res=15100.Zeitformat:elink. ver„ndern.
...
:i2 REFID=INDEX_SETTINGS.šberblick
:lines align=center.:hp7.Einstellungen šberblick:ehp7.:elines.
...
Werten einer Zeitangabe. Er muá genau ein Zeichen lang sein.
.br
Siehe auch
...
Dies hat jedoch keinen Einfluá auf die
...
kann es passieren, daá der CD Spieler sehr viel Rechnerzeit
...
angegeben und muá zwischen 100 und 60000 liegen.
...
:caution.
Bei eingestellter Listenanimation k”nnen gr”áere nderungen an
...
angegeben und muá zwischen 25 und 10000 liegen.
...
des Werts 0 kann erreicht werden, daá der CD Spieler nur dann auf den
...
daá der CD Spieler immer an den Anfang des vorherigen Titels springt.
...
nicht aus, um die Fensterpositionen und - gr”áen zu sichern. Erst wenn
die Position oder Gr”áe eines Fensters nach der Aktivierung dieser Option
ver„ndert wird, werden sie gespeichert.
.br
Unabh„ngig von dieser Einstellung wird beim Start eines Fensters
immer die zuletzt gesicherte Position und Gr”áe eingestellt. Das
heiát Fensterposition und -gr”áe werden immer auf den Wert gesetzt,
den sie hatten als die Speicherung der Fensterposition zuletzt
deaktiviert wurde.
:note.
Einige Fenster k”nnen in der Gr”áe nicht ver„ndert werden. In
...
immer die zuletzt gesicherte Lautst„rke eingestellt. Das heiát
...
Unabh„ngig von dieser Einstellung wird beim Start des CD Spielers
immer die zuletzt gesicherte Position eingestellt. Das heiát
...
:link reftype=hd res=13000.Programmeditor:elink. „ndern ohne daá
...
:p.Die Einstellungen fr die Ausgabe legen fest, ber welchen Anschluá
...
:eul.
:note.
Mindestens ein Anschluá muss eingestellt sein.
...
:h4 res=16005.
:p.:hp8.Fehler: Information about the CD-ROM drive cannot be read.:ehp8.
.br
Dies ist ein fataler Fehler. Der CD Spieler wird beendet.

:h4 res=16006.
:p.:hp8.Fehler: The CD-ROM drive isn't responding.:ehp8.
.br
Dies ist ein fataler Fehler. Der CD Spieler wird beendet.

:h4 res=16007.
:p.:hp8.Fehler: The pause command failed.:ehp8.
.br
Die CD k”nnte defekt sein. Vermeiden Sie die Stelle auf der CD, an der der
PAUSE-Befehl nicht durchgefhrt werden konnte.

:h4 res=16008.
:p.:hp8.Fehler: The play command failed.:ehp8.
.br
Die CD k”nnte defekt sein. Vermeiden Sie die Stelle auf der CD, an der der
PLAY-Befehl nicht durchgefhrt werden konnte.

:h4 res=16009.
:p.:hp8.Fehler: The current position of the disc cannot be read.:ehp8.
.br
Die CD k”nnte defekt sein. Vermeiden Sie die momentane Stelle auf der CD.

:h4 res=16010.
:p.:hp8.Fehler: The output connection isn't available.:ehp8.
.br
Der von Ihnen gew„hlte Ausgabeanschluá ist in der momentanen
Konfiguration nicht verfgbar.

:h4 res=16011.
:p.:hp8.Fehler: The resume command failed.:ehp8.
.br
Die CD k”nnte defekt sein. Vermeiden Sie die Stelle auf der CD, an der der
RESUME-Befehl nicht durchgefhrt werden konnte.

:h4 res=16012.
:p.:hp8.Fehler: The volume cannot be changed.:ehp8.
.br
...
:h4 res=16013.
:p.:hp8.Fehler: The stop command failed.:ehp8.
.br
Dies ist ein fataler Fehler. Der CD Spieler wird beendet.

:h4 res=16014.
:p.:hp8.Fehler: The help file couldn't be opened. :ehp8.
.br
Die Hilfedatei 'CDPLAYER.HLP' muá sich im selben Verzeichnis wie das CD Spieler
Programm 'CDPLAYER.EXE' befinden.

:h4 res=16015.
:p.:hp8.Fehler: The INI-file couldn't be opened or created.:ehp8.
.br
...
:h4 res=16016.
:p.:hp8.Fehler: The INI-file couldn't be actualised. :ehp8.
.br
Beim Versuch, die INI-Datei 'CDPLAYER.INI' zu beschreiben, ist
ein Dateifehler aufgetreten.

:h4 res=16017.
:p.:hp8.Fehler: The timer couldn't be activated.:ehp8.
.br
Dies ist ein fataler Fehler. Der CD Spieler wird beendet.

:h4 res=16018.
:p.:hp8.Fehler: The CD-ROM drive cannot play audio discs.:ehp8.
.br
Dies ist ein fataler Fehler. Der CD Spieler wird beendet.
...
angemessenen Testphase von 30 Tagen weiterhin benutzt, muá
...
:p.Allerdings ist es untersagt, das Programm
:ul.
:li.auf CDROM
:li.zusammen mit Bchern oder Zeitschriften oder „hnlichen Publikationen
(auch "Bookware")
:eul.
zu verbreiten.
...
:p.Sollten Sie sich nach der Dauer von 30 Tagen dafr entscheiden, daá
...
:fig.
    ...
    ÍÍÍÍÍÍÍÍÍ
                  Straáe&colon.      _______________________________________
    ...
    Spenden ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ> DM _____,-
    ...
    (  ) šberweisung auf das Konto 0313312 der Deutschen Bank Darmstadt
